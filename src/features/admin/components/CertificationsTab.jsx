            ...
            <div className="lg:col-span-1">
                <div className="glass-panel text-black dark:text-gray-300 rounded-xl shadow-sm overflow-hidden transition-colors">
                    <div className="p-6 border-b border-black/10 dark:border-white/10">
                        <h2 className="text-lg font-semibold font-heading text-glossy">Add Certification</h2>
                    </div>
                    <div className="p-6">
                        <form onSubmit={(e) => handleSubmit(e, 'certifications')} className="space-y-5">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Issuer / Organization</label>
                                    <input
                                        type="text"
                                        required
                                        className="w-full bg-black/5 dark:bg-[#111] border border-black/10 dark:border-white/10 rounded-lg px-3 py-2 text-gray-900 dark:text-white focus:ring-2 focus:ring-black focus:border-black dark:focus:ring-white dark:focus:border-white outline-none transition-all"
                            ...
                            <div className="space-y-1.5">
                                ...
                                <textarea data-lenis-prevent="true"
                                    ...
                                    placeholder="Brief description or skills gained..."
                            ...
                            <div className="space-y-1.5">
                                <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Credential URL <span className="text-gray-400 font-normal">(Optional)</span></label>
                                <input
                                    type="text"
                            ...
                            <div className="space-y-3 pt-4">
                                <label className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center gap-2">
                                    <ImageIcon size={16} className="text-gray-400" /> Certificate Image / PDF <span className="text-gray-400 font-normal">(Optional)</span>
                                </label>
                                ...
                                <div className="space-y-2">
                                    <div className="relative w-full">
                                        ...
                                        />
                                        <label htmlFor="cert-image-upload" className="w-full flex items-center justify-center gap-2 bg-gray-50 dark:bg-[#111] border border-dashed border-gray-300 dark:border-[#444] rounded-lg py-3 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#222] cursor-pointer transition-colors">
            ...
            <div className="lg:col-span-1 h-fit">
                <div className="bg-white dark:bg-[#141414] rounded-xl shadow-sm border border-gray-200 dark:border-[#333] flex flex-col overflow-hidden transition-colors">
                    <div className="p-6 border-b border-gray-100 dark:border-[#333] flex justify-between items-center bg-gray-50/50 dark:bg-[#222]/50">
                        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Your Certifications</h2>
                                    ...
                                    <div className="space-y-3">
                                        {items.map(item => (
                                            <SortableGenericItem
                                                ...
                                                item={item}
                                                type="Certification"
                                                onDelete={(i) => handleDelete(i, 'certifications')}
                                                onImageClick={(p) => {
                                                    if (p.imageUrl) {
